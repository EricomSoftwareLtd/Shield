...
function build_in_docker() {
    ...
    cp "${BUILD_DIR}/RPMS/x86_64/ericom_shield_kube-"*".rhel.x86_64.rpm" "${BUILD_DIR}/RPMS/x86_64/ericom_shield.rhel.x86_64.rpm"
    cp "${BUILD_DIR}/RPMS/x86_64/ericom_shield_kube-"*".centos.x86_64.rpm" "${BUILD_DIR}/RPMS/x86_64/ericom_shield.centos.x86_64.rpm"
}
